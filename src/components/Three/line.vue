    ...
    export default{
        data(){
            ...
            init : function(){
                ...
                console.log( document.getElementById( 'threeContainer' ) );
                document.getElementById( 'threeContainer' ).appendChild( container );
                ...
                var material = new THREE.SpriteCanvasMaterial( {
                    color : 0x3BB478, opacity : 0.5, program : function(context){
                        context.beginPath();
