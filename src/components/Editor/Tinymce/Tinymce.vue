        ...
        data () {
            ...
            return {
                TinymceId : Id, Editor : null, DefaultConfig : {
                    ...
                    theme : 'modern',
                    menubar : false,
                    toolbar1 : `styleselect | fontselect | formatselect | fontsizeselect | forecolor backcolor | bold italic underline strikethrough `,
                    toolbar2:  `image  media | table | alignleft aligncenter alignright alignjustify | outdent indent | numlist bullist | preview removeformat  hr | paste code  link | undo redo | `,
                    plugins : `paste importcss image code table advlist fullscreen link media lists textcolor colorpicker hr preview`, // CONFIG
                    forced_root_block : 'p',
                    ...
                    style_formats : [{
                        ...
                        title : '行高', items : [{ title : '1', styles : { 'line-height' : '1' }, inline : 'span' }, {
            ...
            value : {
                ...
                type : String, default : 'image/jpeg, image/png, image/jpg,'
            }, maxSize : {
                type : Number, default : 2097152
            }, withCredentials : {
